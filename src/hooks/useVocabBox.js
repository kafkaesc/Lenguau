...
export function useVocabBox(categoryTitle, roundSize) {
	...
	if (categoryTitle !== __categoryTitle || roundSize !== __roundSize) {
		...
		switch (categoryTitle) {
			case 'Around-Town':
				__setVocabBox(shuffle([...townVocab.vocabList]));
				__setVocabTitle(townVocab.title);
				break;
			case 'At-the-Office':
				__setVocabBox(shuffle([...officeVocab.vocabList]));
				__setVocabTitle(officeVocab.title);
				break;
			case 'Colors':
				__setVocabBox(shuffle([...colorsVocab.vocabList]));
				__setVocabTitle(colorsVocab.title);
				break;
			case 'Literature':
				__setVocabBox(shuffle([...literatureVocab.vocabList]));
				__setVocabTitle(literatureVocab.title);
				break;
			case 'Top-50-Verbs':
				__setVocabBox(shuffle([...top50Verbs.vocabList]));
				__setVocabTitle(top50Verbs.title);
				break;
			default:
				console.error(
